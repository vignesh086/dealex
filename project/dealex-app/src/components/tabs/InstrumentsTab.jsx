...
<div style="font-size:8px;letter-spacing:.16em;font-weight:700;color:#4A8BE0;text-transform:uppercase;margin-bottom:6px">SBLC · MT760</div>
<div style="font-size:11px;font-weight:700;color:var(--white);margin-bottom:6px">Project Funding</div>
<div style="font-size:8px;color:var(--muted2);line-height:1.6;margin-bottom:8px">Issuing bank guarantees payment. 366-day tenor. For soft costs and project capital.</div>
<div style="font-size:7.5px;color:#4A8BE0">✓ ISP98 / URDG758 &nbsp;·&nbsp; ✓ 366-day tenor</div>
</div>
<div style="background:rgba(53,160,101,.08);border:1.5px solid rgba(53,160,101,.35);padding:12px">
<div style="font-size:8px;letter-spacing:.16em;font-weight:700;color:var(--green);text-transform:uppercase;margin-bottom:6px">DLC · MT700</div>
<div style="font-size:11px;font-weight:700;color:var(--white);margin-bottom:6px">Commodity Trade</div>
<div style="font-size:8px;color:var(--muted2);line-height:1.6;margin-bottom:8px">Documentary credit. B/L + COO + certs trigger payment. UCP600 governed.</div>
<div style="font-size:7.5px;color:var(--green)">✓ UCP600 &nbsp;·&nbsp; ✓ Sight or Deferred</div>
</div>
</div>
</div>
...
<div><div style="font-size:7px;letter-spacing:.18em;text-transform:uppercase;color:var(--muted);font-weight:600;margin-bottom:3px">DEALEX Reference Number</div>
...
<div style="text-align:right"><div style="font-size:7px;letter-spacing:.12em;text-transform:uppercase;color:var(--muted);margin-bottom:3px">Status</div>
<span class="pill po" id="dealStatusPill">Draft</span></div>
</div>
<div style="font-size:8px;color:var(--muted2);margin-top:6px;line-height:1.5;padding:0 2px">Share this reference with the other party so they can identify the deal. This number is unique to this transaction and will appear on all generated documents.</div>
</div>
...
<div id="doaSub1" style="font-size:8.5px;color:var(--muted2)">Drag & drop your DOA here · .docx or .pdf · or click to browse</div>
<div style="font-size:8px;color:var(--muted);font-style:italic">We'll extract fields automatically — or skip and fill manually</div>
</div>
...
<div class="ic" id="fi-role-sender" onclick="selRole('sender')" style="padding:14px 10px"><div class="ii" style="font-size:24px;margin-bottom:6px">📤</div><div class="it" style="font-size:9px">Sender</div><div class="is">Issuing bank side · Account holder</div></div>
<div class="ic" id="fi-role-receiver" onclick="selRole('receiver')" style="padding:14px 10px"><div class="ii" style="font-size:24px;margin-bottom:6px">📥</div><div class="it" style="font-size:9px">Receiver</div><div class="is">Receiving bank side · Beneficiary</div></div>
<div class="ic" id="fi-role-mandate" onclick="selRole('mandate')" style="padding:14px 10px"><div class="ii" style="font-size:24px;margin-bottom:6px">📋</div><div class="it" style="font-size:9px">Mandate</div><div class="is">Legally appointed · IMFPA holder</div></div>
<div class="ic" id="fi-role-broker" onclick="selRole('broker')" style="padding:14px 10px"><div class="ii" style="font-size:24px;margin-bottom:6px">🤝</div><div class="it" style="font-size:9px">Broker</div><div class="is">Connects parties · Opposite side IMFPA</div></div>
</div>
...
<div style="font-size:9.5px;color:var(--txt);line-height:1.7;margin-bottom:12px">Define how commissions are divided. <strong style="color:var(--gold)">Total must equal 100%.</strong> Default split is 45/45/5/5. If DEALEX is engaged to facilitate, DEALEX takes all commissions and pays broker fees separately.</div>
...
<div style="font-size:9.5px;color:var(--txt);line-height:1.7;margin-bottom:10px">When DEALEX is engaged to facilitate, DEALEX takes all commission proceeds and pays broker fees at the following suggested rates:</div>
<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
<div style="background:var(--obs);border:1px solid var(--border);padding:12px;text-align:center"><div style="font-size:8px;color:var(--muted);letter-spacing:.12em;text-transform:uppercase;margin-bottom:4px">DEALEX Commission</div><div style="font-family:'Inter',sans-serif;font-size:26px;color:var(--gold)">100%</div><div style="font-size:7.5px;color:var(--muted2)">All commission proceeds</div></div>
<div style="background:var(--obs);border:1px solid var(--border);padding:12px;text-align:center"><div style="font-size:8px;color:var(--muted);letter-spacing:.12em;text-transform:uppercase;margin-bottom:4px">Broker Fees Paid</div><div style="font-family:'Inter',sans-serif;font-size:26px;color:var(--green)">YES</div><div style="font-size:7.5px;color:var(--muted2)">Per fee schedule below</div></div>
</div></div>
<div class="st">Suggested DEALEX Broker Fee Schedule</div>
<div style="font-size:9px;color:var(--txt);line-height:1.8">
...
<div style="font-size:9px;font-weight:600;color:var(--txt)">Upload Authorization Letter</div>
<div style="font-size:7.5px;color:var(--muted2);margin-top:2px">Official letter from appointing party · PDF or image</div>
</div>
...
<div style="font-size:9.5px;color:var(--txt);line-height:1.7;margin-bottom:12px">Sign once here. Your signature and initials will be applied to <strong style="color:var(--gold)">every document</strong> — NCNDA, DOA, Term Sheet, IMFPA, and Bank Package. All signatures in <strong style="color:#1A3D7C">blue ink</strong>.</div>

<!-- Full Signature -->
<div style="background:var(--obs);border:1px solid var(--border-mid);padding:16px;margin-bottom:12px">
<div style="font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:600;margin-bottom:8px">Full Signature <span style="color:#4A8BE0;font-style:italic;letter-spacing:.06em">(Blue Ink)</span></div>
...
<button class="bgh" style="flex:1;padding:8px;font-size:8px" onclick="clearSig()">Clear</button>
<button class="bg" style="flex:1;padding:8px;font-size:8px" onclick="saveSig()">✓ Save Signature</button>
</div>
</div>

<!-- Initials -->
<div style="background:var(--obs);border:1px solid var(--border-mid);padding:14px;margin-bottom:12px">
<div style="font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:600;margin-bottom:10px">Initials <span style="color:#4A8BE0;font-style:italic;letter-spacing:.06em">(Blue Ink)</span></div>
...
<div style="font-size:7px;color:var(--muted);margin-bottom:4px">FROM YOUR NAME</div>
...
<div style="font-size:6.5px;color:var(--muted2);margin-top:4px">Click to use</div>
</div>
<!-- Draw custom option -->
<div style="flex:1;text-align:center">
<div style="font-size:7px;color:var(--muted);margin-bottom:4px">OR DRAW YOUR OWN</div>
...
<button class="bgh" style="flex:1;padding:4px;font-size:6.5px" onclick="clearInitials()">Clear</button>
<button class="bg" style="flex:1;padding:4px;font-size:6.5px" onclick="saveInitials()">✓ Save</button>
</div>
</div>
</div>
</div>
...
<div style="flex-shrink:0"><div style="font-size:7px;color:var(--muted);margin-bottom:2px">SIGNATURE</div><img id="sigPreview" style="max-height:30px;max-width:140px;border:1px solid var(--border)" src="" alt=""></div>
<div style="flex-shrink:0"><div style="font-size:7px;color:var(--muted);margin-bottom:2px">INITIALS</div><div id="initialsPreview" style="font-family:Georgia,serif;font-size:18px;font-weight:700;color:#1A3D7C"></div></div>
<div style="flex:1;text-align:right;font-size:7.5px;color:var(--green);font-weight:600">✓ Applied to all documents</div>
</div>
</div>
...
<div style="font-size:9px;color:var(--muted2);margin-bottom:12px">Upload all required documents. Passports must be certified copies. All documents are encrypted and stored securely on-platform.</div>
...
<div style="font-size:28px;margin-bottom:4px">🪪</div>
<div style="font-size:8.5px;font-weight:600;color:var(--txt)">Sender Passport</div>
<div style="font-size:7px;color:var(--muted2);margin-top:2px">Certified copy · Click or drag</div>
</div>
...
<div style="font-size:28px;margin-bottom:4px">🪪</div>
<div style="font-size:8.5px;font-weight:600;color:var(--txt)">Receiver Passport</div>
<div style="font-size:7px;color:var(--muted2);margin-top:2px">Certified copy · Click or drag</div>
</div>
</div>
...
<div style="font-size:7.5px;font-weight:600;color:var(--txt)">CIS / Cert of Inc.</div>
<div style="font-size:6.5px;color:var(--muted2);margin-top:2px">Corporate docs</div>
</div>
...
<div style="font-size:22px;margin-bottom:4px">🔏</div>
<div style="font-size:7.5px;font-weight:600;color:var(--txt)">Company Stamp</div>
<div style="font-size:6.5px;color:var(--muted2);margin-top:2px">Seal / Chop image</div>
</div>
...
<div style="font-size:7.5px;font-weight:600;color:var(--txt)">BCL</div>
<div style="font-size:6.5px;color:var(--muted2);margin-top:2px">Bank Comfort Letter</div>
</div>
</div>
...
<div style="font-size:9.5px;color:var(--txt);line-height:1.7;margin-bottom:12px">All fields complete. Your signature and initials have been captured above. Generate the DOA with all party details, bank coordinates, and document images.</div>
...
<div style="font-size:7px;letter-spacing:.12em;text-transform:uppercase;color:var(--green);font-weight:600;margin-bottom:6px">✓ Your Signature</div>
...
<div style="font-size:9px;color:var(--muted2);margin-bottom:10px">Total must equal <strong style="color:var(--gold)">100%</strong>. Default: 45 / 45 / 5 / 5.</div>
<div class="fr" style="margin-bottom:6px">
...
<div style="font-size:8.5px;color:var(--muted2);margin-bottom:10px">If these details were found in your DOA, they're shown below automatically. You can still upload certified copies for the official record.</div>

<!-- Auto-populated from DOA -->
<div id="tsExtractedDocs" style="display:none;margin-bottom:12px">
<div style="font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--green);font-weight:600;margin-bottom:8px">✓ Extracted from DOA</div>
...
<div style="font-size:8px;color:var(--muted);line-height:1.5;margin-bottom:8px">These were found in your DOA and will appear on all generated documents. Upload certified copies below if your counterparty or bank requires them on file.</div>
</div>
...
<div style="font-size:8px;font-weight:600;color:var(--txt)">Sender Passport</div>
<div style="font-size:6.5px;color:var(--muted2);margin-top:2px" id="tsSenderPPStatus">Certified copy · Click or drag</div>
</div>
...
<div style="font-size:22px;margin-bottom:3px">🪪</div>
<div style="font-size:8px;font-weight:600;color:var(--txt)">Receiver Passport</div>
<div style="font-size:6.5px;color:var(--muted2);margin-top:2px" id="tsReceiverPPStatus">Certified copy · Click or drag</div>
</div>
</div>
<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px">
...
<div style="font-size:22px;margin-bottom:3px">🏢</div>
<div style="font-size:8px;font-weight:600;color:var(--txt)">Sender Certificate</div>
<div style="font-size:6.5px;color:var(--muted2);margin-top:2px" id="tsSenderCertStatus">Cert of Inc. / CIS</div>
</div>
...
<div style="font-size:22px;margin-bottom:3px">🏢</div>
<div style="font-size:8px;font-weight:600;color:var(--txt)">Receiver Certificate</div>
<div style="font-size:6.5px;color:var(--muted2);margin-top:2px" id="tsReceiverCertStatus">Cert of Inc. / CIS</div>
</div>
</div>
<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:12px">
...
<div style="font-size:22px;margin-bottom:3px">📋</div>
<div style="font-size:8px;font-weight:600;color:var(--txt)">Sender Mandate Passport</div>
<div style="font-size:6.5px;color:var(--muted2);margin-top:2px">If applicable</div>
</div>
...
<div style="font-size:22px;margin-bottom:3px">📋</div>
<div style="font-size:8px;font-weight:600;color:var(--txt)">Receiver Mandate Passport</div>
<div style="font-size:6.5px;color:var(--muted2);margin-top:2px">If applicable</div>
</div>
</div>
...
<div style="font-size:9.5px;color:var(--txt);line-height:1.7;margin-bottom:12px">This is what the <strong style="color:var(--gold)">Sender walks into the bank with</strong>. Without a clean, bank-grade issuance package backed by real funds and a real banking relationship, the deal was never real to begin with.</div>
...
<div style="font-size:9px;color:var(--muted2);margin-bottom:10px;line-height:1.6">The CIL instructs your bank to issue the instrument and prepare it for SWIFT transmission. This is the document that <strong style="color:var(--gold)">activates the bank</strong>. Without it, nothing moves.</div>
...
<div style="font-size:9px;color:var(--muted2);margin-bottom:10px;line-height:1.6">No block = no issuance. The bank will not issue without confirmed collateral.</div>
...
<div style="font-size:9px;color:var(--muted2);margin-bottom:10px;line-height:1.6">Sender agrees to pay all bank issuance fees. Typically 0.5% – 2% of face value depending on banking relationship.</div>
<div class="fr" style="margin-bottom:6px">
...
<div style="font-size:9px;color:var(--muted2);margin-bottom:10px;line-height:1.6">Even if the sender is an existing client, the bank will re-verify for large instruments. Upload supporting evidence.</div>
...
<div style="font-size:7.5px;font-weight:600;color:var(--txt)">Source of Funds</div>
...
<div style="font-size:18px;margin-bottom:3px">👤</div>
<div style="font-size:7.5px;font-weight:600;color:var(--txt)">UBO Declaration</div>
...
<div style="font-size:18px;margin-bottom:3px">📊</div>
<div style="font-size:7.5px;font-weight:600;color:var(--txt)">Balance Sheet</div>
...
<div style="font-size:9px;color:var(--muted2);margin-bottom:10px;line-height:1.6">If anything flags, compliance will freeze the file instantly. Confirm all declarations truthfully.</div>
<div id="complianceChecks">
<div class="cr" onclick="toggleCompCheck(0)"><div class="cx" id="compCx0"></div><div style="flex:1"><div style="font-size:10px;font-weight:500;color:var(--white)">Non-Sanctioned Parties — Neither party appears on OFAC, EU, or UN sanctions lists</div></div></div>
<div class="cr" onclick="toggleCompCheck(1)"><div class="cx" id="compCx1"></div><div style="flex:1"><div style="font-size:10px;font-weight:500;color:var(--white)">Non-Prohibited Use — Funds and instrument not used for prohibited purposes</div></div></div>
<div class="cr" onclick="toggleCompCheck(2)"><div class="cx" id="compCx2"></div><div style="flex:1"><div style="font-size:10px;font-weight:500;color:var(--white)">AML / CFT Compliance — Transaction complies with Anti-Money Laundering and Counter-Terrorism Financing regulations</div></div></div>
<div class="cr" onclick="toggleCompCheck(3)"><div class="cx" id="compCx3"></div><div style="flex:1"><div style="font-size:10px;font-weight:500;color:var(--white)">No Fraud Declaration — No intent to defraud, misrepresent, or engage in circular trading</div></div></div>
<div class="cr" onclick="toggleCompCheck(4)"><div class="cx" id="compCx4"></div><div style="flex:1"><div style="font-size:10px;font-weight:500;color:var(--white)">Not a Monetization Structure — Instrument is not for immediate discount, monetization, or credit-line leveraging</div></div></div>
</div>

<!-- 6. Readiness Checklist -->
<div class="st">6. Bank Package Readiness</div>
<div style="font-size:9px;color:var(--muted2);margin-bottom:10px;line-height:1.6">Every item below must be ✓ before you walk into your bank. This is the reality check.</div>
...
<div style="flex:1"><div style="font-size:10px;font-weight:500;color:var(--white)">Issuing bank officer confirms ready to transmit on booking date</div><div style="font-size:7px;color:var(--red);font-weight:700;margin-top:2px;letter-spacing:.12em;text-transform:uppercase">REQUIRED</div></div>
</div>
...
<div style="flex:1"><div style="font-size:10px;font-weight:500;color:var(--white)">Advising bank officer confirms ready to receive on booking date</div><div style="font-size:7px;color:var(--red);font-weight:700;margin-top:2px;letter-spacing:.12em;text-transform:uppercase">REQUIRED</div></div>
</div>
...
<div style="font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--green);font-weight:600;margin-bottom:6px">✓ BOOKING CONFIRMED</div>
...
<div style="font-size:9.5px;color:var(--txt);line-height:1.7">NCNDA signed. DOA generated. Term Sheet configured. IMFPA produced. Bank package prepared. Now invite the other party to complete their side.</div>
</div>

<!-- DEALEX as Paymaster -->
<div style="background:rgba(59,73,223,.06);border:1px solid rgba(59,73,223,.25);padding:14px;margin-bottom:12px">
<div style="font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:600;margin-bottom:8px">Paymaster selection</div>
...
<div><strong style="color:var(--white);font-size:11px">DEALEX as Paymaster</strong><br><span style="font-size:9px;color:var(--muted2)">Banking details stay on-platform. Commissions disbursed by DEALEX. Nobody sees anyone else's bank info.</span></div>
</div>
<div class="wiz-check" onclick="selectPaymaster('external',this)" id="pmExternal">
<div class="wc-box" role="checkbox" aria-checked="false">✓</div>
<div><strong style="color:var(--white);font-size:11px">External paymaster</strong><br><span style="font-size:9px;color:var(--muted2)">Use your own paymaster or escrow agent. Banking details shared as per IMFPA terms.</span></div>
</div>
</div>
...
<div style="font-size:10px;color:var(--green);font-weight:600;margin-bottom:4px">🔒 Banking details protected by DEALEX</div>
...
<!-- Deal Reference -->
<div style="display:flex;align-items:center;gap:8px;margin-bottom:12px;padding:8px 10px;background:var(--obs);border:1px solid var(--border-mid)"><div style="font-size:7px;letter-spacing:.14em;text-transform:uppercase;color:var(--muted);font-weight:600">Deal Reference:</div><div style="font-family:'JetBrains Mono',monospace;font-size:15px;color:var(--gold);font-weight:700;letter-spacing:.04em" class="deal-ref-display">—</div><div style="margin-left:auto;font-size:7px;color:var(--muted);cursor:pointer;text-decoration:underline" onclick="copyDealRef()">Copy Ref</div></div>

<!-- Broker: Invite BOTH sides separately -->
<div id="brokerInviteSection" style="display:none">
<div style="font-size:9px;color:var(--gold);font-weight:600;letter-spacing:.12em;text-transform:uppercase;margin-bottom:10px">You're a broker — invite both sides</div>

<!-- Invite Sender -->
<div style="background:var(--obs);border:1px solid var(--border);padding:12px;margin-bottom:8px">
<div style="display:flex;align-items:center;gap:8px;margin-bottom:8px">
<span style="font-size:18px">📤</span>
<div><strong style="color:var(--white);font-size:11px">Invite Sender</strong><br><span style="font-size:8px;color:var(--muted2)">The party who will issue the SBLC / instrument</span></div>
...
<div style="display:flex;align-items:center;gap:8px;margin-bottom:8px">
<span style="font-size:18px">📥</span>
<div><strong style="color:var(--white);font-size:11px">Invite Receiver</strong><br><span style="font-size:8px;color:var(--muted2)">The party who will receive and monetize the instrument</span></div>
...
<div style="font-size:8px;letter-spacing:.12em;text-transform:uppercase;color:var(--green);font-weight:600;margin-bottom:6px">✓ Invite Ready</div>
<div style="font-size:9.5px;color:var(--txt);line-height:1.6;margin-bottom:8px">If your email app didn't open, copy the message below and send it manually.</div>
<div style="display:flex;gap:6px">
<button class="bgh" style="flex:1;padding:8px;font-size:8px" onclick="copyInviteMessage()">📋 Copy Full Invite</button>
<button class="bgh" style="flex:1;padding:8px;font-size:8px" onclick="copyEmailLink()">🔗 Copy Email Link</button>
</div>
</div>
<div style="font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:600;margin-bottom:6px">Preview</div>
<div id="invitePreviewBody" style="background:var(--obs);border:1px solid var(--border);padding:12px;font-size:9px;color:var(--txt);line-height:1.7;white-space:pre-wrap;font-family:'JetBrains Mono',monospace;max-height:200px;overflow-y:auto"></div>
</div>
<div style="font-size:8px;color:var(--muted);margin-top:8px;line-height:1.6;text-align:center">📧 Opens your email client · 📋 Copies the full invite to paste anywhere</div>
</div></div>
</div>
...
<div style="font-size:8px;letter-spacing:.12em;text-transform:uppercase;color:var(--gold);font-weight:600;margin-bottom:6px">What the law requires</div>
<div style="font-size:9px;color:var(--txt);line-height:1.8">
...
<div style="background:var(--obs);border:1px solid var(--border);padding:10px">
<div style="font-size:8px;letter-spacing:.12em;text-transform:uppercase;color:var(--gold);font-weight:600;margin-bottom:6px">What banks will reject without</div>
<div style="font-size:9px;color:var(--txt);line-height:1.8">
...
<div style="font-size:8px;letter-spacing:.12em;text-transform:uppercase;color:var(--gold);font-weight:600;margin-bottom:6px">Standard CIS / KYC package</div>
<div style="display:grid;grid-template-columns:1fr 1fr;gap:4px;margin-bottom:10px">
<div style="font-size:9px;color:var(--txt);padding:5px 8px;background:var(--obs);border:1px solid var(--border)">✓ Passport copy (certified)</div>
<div style="font-size:9px;color:var(--txt);padding:5px 8px;background:var(--obs);border:1px solid var(--border)">✓ Certificate of Incorporation</div>
<div style="font-size:9px;color:var(--txt);padding:5px 8px;background:var(--obs);border:1px solid var(--border)">✓ Company registration certificate</div>
<div style="font-size:9px;color:var(--txt);padding:5px 8px;background:var(--obs);border:1px solid var(--border)">✓ Proof of address (utility bill / bank statement)</div>
<div style="font-size:9px;color:var(--txt);padding:5px 8px;background:var(--obs);border:1px solid var(--border)">✓ Bank reference letter / BCL</div>
<div style="font-size:9px;color:var(--txt);padding:5px 8px;background:var(--obs);border:1px solid var(--border)">✓ Financial statements (audited if available)</div>
<div style="font-size:9px;color:var(--txt);padding:5px 8px;background:var(--obs);border:1px solid var(--border)">✓ Ultimate Beneficial Owner (UBO) declaration</div>
<div style="font-size:9px;color:var(--txt);padding:5px 8px;background:var(--obs);border:1px solid var(--border)">✓ Source of funds declaration</div>
</div>

<div style="background:rgba(42,128,80,.08);border:1px solid rgba(42,128,80,.25);padding:10px">
<div style="font-size:10px;color:var(--green);font-weight:600;margin-bottom:4px">🛡️ How DEALEX protects you</div>
