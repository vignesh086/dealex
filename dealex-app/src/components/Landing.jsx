...
.lang-tab{flex:1;padding:11px 0;font-size:9px;letter-spacing:.2em;text-transform:uppercase;font-weight:700;font-family:'Inter',sans-serif;background:none;border:none;color:var(--muted);cursor:pointer;border-bottom:2px solid transparent;transition:all .18s}
...
.role-name{font-size:10px;font-weight:700;color:var(--white);margin-bottom:3px;line-height:1.2}
.role-sub{font-size:8px;color:var(--muted2);line-height:1.5}
/* Education panels */
...
.doc-req-body{}
.doc-req-label{font-size:9.5px;font-weight:600;color:var(--white);margin-bottom:2px}
.doc-req-desc{font-size:8px;color:var(--muted2);line-height:1.5}
.doc-missing{display:inline-block;padding:2px 7px;background:rgba(208,64,64,.12);border:1px solid rgba(208,64,64,.3);font-size:7px;font-weight:700;letter-spacing:.1em;color:var(--red);text-transform:uppercase;margin-top:4px}
/* Upload link box */
...
/* Step number badge */
.step-num{width:22px;height:22px;border-radius:50%;background:var(--gold);color:var(--obs);font-size:9px;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-family:'Inter',sans-serif}
...
<div id="lc-en" style="flex:1;display:flex;flex-direction:column;overflow-y:auto">
  ...
  <div class="lhero" style="flex:none;min-height:auto;padding:22px 20px 18px">
    ...
    <div style="position:relative;z-index:1">
      <div class="lpre">Global Deal Platform — No Zoom Calls. No WhatsApp.</div>
  ...
  <div style="padding:0 16px;margin-bottom:16px">
    ...
    <div style="background:var(--panel);border:1px solid var(--border);padding:14px">
      ...
      <style>
        ...
        .pd-box-title{font-size:9px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;line-height:1.3;margin-bottom:2px}
        .pd-box-sub{font-size:7.5px;color:var(--muted2);line-height:1.4}
      ...
      <div style="display:flex;flex-direction:column;gap:0;margin-bottom:10px">
        ...
        <div class="pd-row">
          <div class="pd-box" style="border-color:rgba(74,139,224,.5);background:rgba(74,139,224,.1)">
            <div class="pd-box-title" style="color:#4A8BE0">PRINCIPAL A<br><span style="font-size:7px;opacity:.8">(SENDER)</span></div>
          ...
          <div class="pd-box" style="border-color:rgba(53,160,101,.5);background:rgba(53,160,101,.1)">
            <div class="pd-box-title" style="color:#10B981">PRINCIPAL B<br><span style="font-size:7px;opacity:.8">(RECEIVER)</span></div>
        ...
        <div class="pd-row">
          <div class="pd-box" style="border-color:rgba(74,139,224,.3);background:rgba(74,139,224,.05)">
            <div class="pd-box-title" style="color:#4A8BE0;font-size:8.5px">MANDATE A</div>
          ...
          <div class="pd-box" style="border-color:rgba(53,160,101,.3);background:rgba(53,160,101,.05)">
            <div class="pd-box-title" style="color:#10B981;font-size:8.5px">MANDATE B</div>
        ...
        <div class="pd-row">
          <div class="pd-box" style="border-color:rgba(59,73,223,.75);border-width:2px;background:rgba(59,73,223,.15);max-width:100%;flex:none;width:80%;margin:0 auto">
            <div class="pd-box-title" style="color:var(--gold);font-size:9px;letter-spacing:.12em">DEALEX — NEUTRAL PLATFORM</div>
      ...
      <div style="font-size:8px;color:var(--muted2);line-height:1.7;border-top:1px solid var(--border);padding-top:8px">
  ...
  <div style="padding:0 16px;margin-bottom:16px">
    <div style="font-size:9px;letter-spacing:.18em;text-transform:uppercase;color:var(--gold);font-weight:700;margin-bottom:10px">▸ SELECT YOUR ROLE TO SEE WHAT YOU NEED</div>
    <div class="role-grid">
    ...
    <div class="edu-panel" id="ep-principal">
      <div class="info-callout green" style="margin-bottom:10px">
        <div style="font-size:9px;font-weight:700;color:var(--green);margin-bottom:4px">You are a Principal — you initiate and own the deal.</div>
        <div style="font-size:8.5px;color:var(--txt);line-height:1.7">As the deal owner, you sign the DOA directly. You may appoint up to 1 Mandate to represent you. Your CIS and KYC go to DEALEX only — not to the other side.</div>
      </div>
      <div style="font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--red);font-weight:700;margin-bottom:6px">MUST HAVE — deal cannot start</div>
      ...
      <div style="font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:700;margin:10px 0 6px">SHOULD HAVE — strengthens your position</div>
      ...
      <div class="link-gen-box" style="margin-top:12px">
        <div style="font-size:9px;font-weight:700;color:#4A8BE0;margin-bottom:6px">📎 Send a secure upload link to your Mandate or Broker</div>
        <div style="font-size:8px;color:var(--muted2);line-height:1.5;margin-bottom:8px">Your Mandate or Broker can collect documents on your behalf. Generate a one-time secure link — they upload, you approve, DEALEX verifies. They never see your CIS.</div>
    ...
    <div class="edu-panel" id="ep-mandate">
      <div class="info-callout" style="margin-bottom:10px">
        <div style="font-size:9px;font-weight:700;color:var(--gold);margin-bottom:4px">You are a Mandate — you need proof of authority.</div>
        <div style="font-size:8.5px;color:var(--txt);line-height:1.7">A Mandate must be formally appointed by a Principal. Without a Mandate Letter from your Principal, you cannot represent them on DEALEX. This is not optional — it is how banks and counterparties verify authority.</div>
      </div>
      <div style="font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--red);font-weight:700;margin-bottom:6px">MUST HAVE — without these, deal cannot proceed</div>
      ...
      <div class="info-callout red" style="margin:10px 0">
        <div style="font-size:9px;font-weight:700;color:var(--red);margin-bottom:4px">❌ Don't have a Mandate Letter?</div>
        <div style="font-size:8.5px;color:var(--txt);line-height:1.7">You cannot proceed as Mandate without it. Options:<br>
      ...
      <div style="font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:700;margin-bottom:6px">YOUR IMFPA RIGHTS</div>
      <div class="info-callout" style="margin-bottom:10px">
        <div style="font-size:8.5px;color:var(--txt);line-height:1.7">As a Mandate, you may negotiate your own IMFPA with your Principal separately. <strong style="color:var(--white)">DEALEX does not include Mandate IMFPAs in the DOA</strong> — the DOA only reflects Principals and Brokers. Your IMFPA is a private arrangement protected by NCNDA.</div>
      </div>

      <div class="link-gen-box">
        <div style="font-size:9px;font-weight:700;color:#4A8BE0;margin-bottom:6px">📎 Send upload link to your Principal</div>
        <div style="font-size:8px;color:var(--muted2);line-height:1.5;margin-bottom:8px">Your Principal can upload their Mandate Letter, passport, and company docs directly to DEALEX. You assemble the deal package — they retain full control of what they share.</div>
    ...
    <div class="edu-panel" id="ep-broker">
      <div class="info-callout green" style="margin-bottom:10px">
        <div style="font-size:9px;font-weight:700;color:var(--green);margin-bottom:4px">You are a Broker — DEALEX protects your position.</div>
        <div style="font-size:8.5px;color:var(--txt);line-height:1.7">You may have one side of a deal (Sender or Receiver) or both. DEALEX acts as paymaster — your commission is protected by IMFPA from the start. You are never cut out.</div>
      </div>

      <div style="font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:700;margin-bottom:6px">WHAT YOU NEED TO OPEN A DEAL</div>
      ...
      <div style="font-size:8px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:700;margin:10px 0 6px">WHAT YOUR PRINCIPAL MUST PROVIDE</div>
      <div style="font-size:8.5px;color:var(--txt);line-height:1.7;margin-bottom:8px">If you are acting on behalf of a Principal, these are the items that must come from them — not you. Use the upload link to collect them without exposing your deal structure.</div>
      ...
      <div class="link-gen-box">
        <div style="font-size:9px;font-weight:700;color:#4A8BE0;margin-bottom:6px">📎 Send upload link to your Principal or counterparty</div>
        <div style="font-size:8px;color:var(--muted2);line-height:1.5;margin-bottom:8px">Select which party gets the link and which documents to request. They upload to DEALEX directly — you are notified when complete. No WhatsApp. No email attachments.</div>
    ...
    <div class="edu-panel" id="ep-bank">
      <div class="info-callout" style="margin-bottom:10px">
        <div style="font-size:9px;font-weight:700;color:var(--gold);margin-bottom:4px">You are a Bank Officer — you receive and authenticate instruments.</div>
        <div style="font-size:8.5px;color:var(--txt);line-height:1.7">DEALEX generates fully compliant SWIFT MT760 (SBLC) and MT700 (DLC) drafts. Your role is to review, authenticate, and transmit. All instruments follow SWIFT Category 7 November 2025 Standards.</div>
      </div>
  ...
  <div style="padding:0 16px;margin-bottom:16px">
    ...
    <div style="background:var(--panel);border:1px solid var(--border);padding:14px">
      <div style="font-size:8.5px;color:var(--txt);line-height:1.7;margin-bottom:10px">DEALEX does not float paperwork. Every document is routed on a need-to-see basis only.</div>
      <div style="display:flex;flex-direction:column;gap:5px">
        <div class="party-row"><div class="party-dot" style="background:#4A8BE0"></div><div style="flex:1"><span style="font-size:9px;font-weight:600;color:var(--white)">CIS / KYC</span><span style="font-size:8px;color:var(--muted2)"> — to DEALEX only. Counterparty sees: <strong style="color:var(--green)">✓ Verified</strong></span></div></div>
        <div class="party-row"><div class="party-dot" style="background:var(--gold)"></div><div style="flex:1"><span style="font-size:9px;font-weight:600;color:var(--white)">NCNDA</span><span style="font-size:8px;color:var(--muted2)"> — both parties sign before any deal detail is shared</span></div></div>
        <div class="party-row"><div class="party-dot" style="background:var(--gold)"></div><div style="flex:1"><span style="font-size:9px;font-weight:600;color:var(--white)">DOA</span><span style="font-size:8px;color:var(--muted2)"> — shared with both Principals and their banks only. Mandate IMFPA not included.</span></div></div>
        <div class="party-row"><div class="party-dot" style="background:var(--gold)"></div><div style="flex:1"><span style="font-size:9px;font-weight:600;color:var(--white)">IMFPA</span><span style="font-size:8px;color:var(--muted2)"> — broker's IMFPA goes to Principals only. DEALEX is paymaster.</span></div></div>
        <div class="party-row"><div class="party-dot" style="background:var(--green)"></div><div style="flex:1"><span style="font-size:9px;font-weight:600;color:var(--white)">MT760 / MT700</span><span style="font-size:8px;color:var(--muted2)"> — transmitted bank-to-bank via authenticated SWIFT only. Not emailed.</span></div></div>
        <div class="party-row"><div class="party-dot" style="background:var(--muted)"></div><div style="flex:1"><span style="font-size:9px;font-weight:600;color:var(--white)">Commodity Docs (B/L, COO, certs)</span><span style="font-size:8px;color:var(--muted2)"> — released to buyer's bank only upon compliant presentation under DLC terms.</span></div></div>
      </div>
    </div>
  </div>
  ...
  <div style="padding:0 16px;margin-bottom:16px">
    <div style="font-size:9px;letter-spacing:.18em;text-transform:uppercase;color:var(--gold);font-weight:700;margin-bottom:10px">▸ SUCCESSFUL DEAL CLOSERS</div>
    <div style="background:var(--panel);border:1px solid var(--border);padding:14px;margin-bottom:8px">
      <div style="font-size:8.5px;color:var(--txt);line-height:1.7;margin-bottom:10px">Parties that have successfully closed deals through DEALEX are listed in our verified database. This is your track record on the platform. Counterparties can request to see your deal history — with your permission.</div>
      <div class="closer-card"><div style="width:32px;height:32px;border-radius:50%;background:rgba(53,160,101,.2);border:1px solid rgba(53,160,101,.4);display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0">✓</div><div><div style="font-size:9.5px;font-weight:700;color:var(--green)">DLX-008821 · SBLC EUR 50M · Germany → Malaysia</div><div style="font-size:7.5px;color:var(--muted2)">Closed Q4 2024 · 2 Principals · 1 Broker · 18 days</div></div></div>
      <div class="closer-card"><div style="width:32px;height:32px;border-radius:50%;background:rgba(53,160,101,.2);border:1px solid rgba(53,160,101,.4);display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0">✓</div><div><div style="font-size:9.5px;font-weight:700;color:var(--green)">DLX-011403 · DLC Bauxite 49,739 MT · Malaysia</div><div style="font-size:7.5px;color:var(--muted2)">Closed Q1 2025 · FOB Kuantan · CCIC Certified · 12 days</div></div></div>
      <div class="closer-card"><div style="width:32px;height:32px;border-radius:50%;background:rgba(53,160,101,.2);border:1px solid rgba(53,160,101,.4);display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0">✓</div><div><div style="font-size:9.5px;font-weight:700;color:var(--green)">DLX-013290 · SBLC USD 120M · Singapore → UAE</div><div style="font-size:7.5px;color:var(--muted2)">Closed Q2 2025 · 1 Mandate each side · 22 days</div></div></div>
      <div style="text-align:center;padding-top:8px;border-top:1px solid var(--border);margin-top:6px"><span style="font-size:8px;color:var(--muted);letter-spacing:.12em">340+ DEALS IN DATABASE · GROWING DAILY</span></div>
    </div>
  </div>
...
<div id="lc-zh" style="flex:1;display:none;flex-direction:column;overflow-y:auto" class="zh">
  ...
  <!-- Party Structure ZH -->
  <div style="padding:0 16px;margin-bottom:16px">
    <div style="font-size:9px;letter-spacing:.1em;text-transform:uppercase;color:var(--gold);font-weight:700;margin-bottom:10px;font-family:'Noto Sans SC',sans-serif">▸ 每笔交易的固定结构</div>
    <div style="background:var(--panel);border:1px solid var(--border);padding:14px">
      <div style="display:flex;flex-direction:column;gap:6px;font-family:'Noto Sans SC',sans-serif">
        <div class="party-row"><div class="party-dot" style="background:#4A8BE0"></div><div><div style="font-size:10px;font-weight:700;color:#4A8BE0">主体方 A（发送方）</div><div style="font-size:8px;color:var(--muted2)">申请人 / 开证行</div></div></div>
        <div class="party-row"><div class="party-dot" style="background:var(--green)"></div><div><div style="font-size:10px;font-weight:700;color:var(--green)">主体方 B（接收方）</div><div style="font-size:8px;color:var(--muted2)">受益人 / 通知行</div></div></div>
        <div class="party-row"><div class="party-dot" style="background:rgba(59,73,223,.6)"></div><div><div style="font-size:10px;font-weight:600;color:var(--txt)">授权代表（最多各1名）</div><div style="font-size:8px;color:var(--muted2)">由主体方任命，须持有授权书。授权代表可有独立的IMFPA，但不体现在DOA中。</div></div></div>
        <div class="party-row"><div class="party-dot" style="background:var(--gold)"></div><div><div style="font-size:10px;font-weight:700;color:var(--gold)">经纪人</div><div style="font-size:8px;color:var(--muted2)">受IMFPA保护 · DEALEX担任付款代理</div></div></div>
        <div class="party-row"><div class="party-dot" style="background:var(--gold);opacity:.5"></div><div><div style="font-size:10px;font-weight:700;color:var(--gold)">DEALEX — 中立平台</div><div style="font-size:8px;color:var(--muted2)">控制流程 · 核验文件 · 路由文件</div></div></div>
      </div>
      <div style="font-size:8px;color:var(--muted2);margin-top:8px;padding-top:8px;border-top:1px solid var(--border);font-family:'Noto Sans SC',sans-serif">
  ...
  <!-- Role Selector ZH -->
  <div style="padding:0 16px;margin-bottom:16px">
    <div style="font-size:9px;letter-spacing:.1em;color:var(--gold);font-weight:700;margin-bottom:10px;font-family:'Noto Sans SC',sans-serif">▸ 选择您的角色，了解所需材料</div>
    <div class="role-grid">
    ...
    <div class="edu-panel" id="ep-zh-mandate">
      <div class="info-callout" style="margin-bottom:10px">
        <div style="font-size:10px;font-weight:700;color:var(--gold);margin-bottom:4px;font-family:'Noto Sans SC',sans-serif">您是授权代表 — 必须持有委托书</div>
        <div style="font-size:9px;color:var(--txt);line-height:1.8;font-family:'Noto Sans SC',sans-serif">授权代表必须由主体方正式任命。没有主体方签署的<strong style="color:var(--white)">授权委托书（Mandate Letter）</strong>，您无法在DEALEX上代表主体方。这不是可选项——这是银行和交易对手方核验授权的方式。</div>
      </div>
      ...
      <div class="info-callout red" style="margin:10px 0">
        <div style="font-size:9px;font-weight:700;color:var(--red);margin-bottom:4px;font-family:'Noto Sans SC',sans-serif">❌ 没有授权委托书？</div>
        <div style="font-size:8.5px;color:var(--txt);line-height:1.8;font-family:'Noto Sans SC',sans-serif">
      ...
      <div class="link-gen-box">
        <div style="font-size:9px;font-weight:700;color:#4A8BE0;margin-bottom:6px;font-family:'Noto Sans SC',sans-serif">📎 向主体方发送安全上传链接</div>
        <div style="font-size:8px;color:var(--muted2);line-height:1.6;margin-bottom:8px;font-family:'Noto Sans SC',sans-serif">主体方可通过专属链接直接向DEALEX上传委托书、护照及公司文件。您组建文件包——他们保留对所分享内容的完全控制权。</div>
    ...
    <div class="edu-panel" id="ep-zh-principal">
      <div class="info-callout green" style="margin-bottom:10px">
        <div style="font-size:10px;font-weight:700;color:var(--green);margin-bottom:4px;font-family:'Noto Sans SC',sans-serif">您是主体方 — 您是交易的发起人和拥有者</div>
        <div style="font-size:9px;color:var(--txt);line-height:1.8;font-family:'Noto Sans SC',sans-serif">作为交易主体，您直接签署DOA（授权协议）。您可指定最多1名授权代表代理您。您的KYC/CIS只提交给DEALEX——不发送给交易对手方。</div>
      </div>
      ...
      <div class="link-gen-box">
        <div style="font-size:9px;font-weight:700;color:#4A8BE0;margin-bottom:6px;font-family:'Noto Sans SC',sans-serif">📎 向授权代表或经纪人发送安全上传链接</div>
    ...
    <div class="edu-panel" id="ep-zh-broker">
      <div class="info-callout green" style="margin-bottom:10px">
        <div style="font-size:10px;font-weight:700;color:var(--green);margin-bottom:4px;font-family:'Noto Sans SC',sans-serif">您是经纪人 — DEALEX保护您的权益</div>
        <div style="font-size:9px;color:var(--txt);line-height:1.8;font-family:'Noto Sans SC',sans-serif">您可能持有交易的一方（发送方或接收方）或双方资源。DEALEX担任付款代理——您的佣金从一开始就受IMFPA保护，确保您不被踢出局。</div>
      </div>
      ...
      <div class="link-gen-box">
        <div style="font-size:9px;font-weight:700;color:#4A8BE0;margin-bottom:6px;font-family:'Noto Sans SC',sans-serif">📎 向主体方或交易对手方发送上传链接</div>
    ...
    <div class="edu-panel" id="ep-zh-bank">
      <div class="info-callout" style="margin-bottom:10px">
        <div style="font-size:10px;font-weight:700;color:var(--gold);margin-bottom:4px;font-family:'Noto Sans SC',sans-serif">您是银行人员 — 负责接收和认证金融工具</div>
  ...
  <div style="padding:0 16px;margin-bottom:16px">
    <div style="font-size:9px;letter-spacing:.1em;color:var(--gold);font-weight:700;margin-bottom:10px;font-family:'Noto Sans SC',sans-serif">▸ 成功成交记录</div>
    <div style="background:var(--panel);border:1px solid var(--border);padding:14px;margin-bottom:8px">
      <div class="closer-card"><div style="width:32px;height:32px;border-radius:50%;background:rgba(53,160,101,.2);border:1px solid rgba(53,160,101,.4);display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0">✓</div><div><div style="font-size:9.5px;font-weight:700;color:var(--green);font-family:'Noto Sans SC',sans-serif">DLX-008821 · SBLC 5000万欧元 · 德国→马来西亚</div><div style="font-size:7.5px;color:var(--muted2);font-family:'Noto Sans SC',sans-serif">2024年Q4成交 · 2名主体方 · 1名经纪人 · 18天</div></div></div>
      <div class="closer-card"><div style="width:32px;height:32px;border-radius:50%;background:rgba(53,160,101,.2);border:1px solid rgba(53,160,101,.4);display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0">✓</div><div><div style="font-size:9.5px;font-weight:700;color:var(--green);font-family:'Noto Sans SC',sans-serif">DLX-011403 · DLC 铝土矿49,739公吨 · 马来西亚关丹</div><div style="font-size:7.5px;color:var(--muted2);font-family:'Noto Sans SC',sans-serif">2025年Q1成交 · FOB关丹 · CCIC认证 · 12天</div></div></div>
      <div class="closer-card"><div style="width:32px;height:32px;border-radius:50%;background:rgba(53,160,101,.2);border:1px solid rgba(53,160,101,.4);display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0">✓</div><div><div style="font-size:9.5px;font-weight:700;color:var(--green);font-family:'Noto Sans SC',sans-serif">DLX-013290 · SBLC 1.2亿美元 · 新加坡→阿联酋</div><div style="font-size:7.5px;color:var(--muted2);font-family:'Noto Sans SC',sans-serif">2025年Q2成交 · 双方各1名授权代表 · 22天</div></div></div>
      <div style="text-align:center;padding-top:8px;border-top:1px solid var(--border);margin-top:6px"><span style="font-size:8px;color:var(--muted);font-family:'Noto Sans SC',sans-serif">数据库中已有340+笔成交记录，每日更新</span></div>
    </div>
  </div>
...
<div id="uploadLinkModal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,.85);backdrop-filter:blur(12px);z-index:1060;align-items:center;justify-content:center;padding:20px">
  <div style="background:var(--panel);border:1px solid var(--border-hi);padding:20px;max-width:360px;width:100%;max-height:80vh;overflow-y:auto">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px">
      <div style="font-size:10px;letter-spacing:.16em;text-transform:uppercase;font-weight:700;color:var(--gold)">SECURE UPLOAD LINK</div>
    ...
    <div style="font-size:9px;color:var(--muted2);line-height:1.7;margin-bottom:14px" id="ulm-desc">Generate a one-time link for your party to upload documents directly to DEALEX. They never see your documents or deal details.</div>
    ...
    <div style="margin-bottom:12px">
      ...
      <div style="display:flex;flex-direction:column;gap:5px" id="ulm-docs">
        <label style="display:flex;gap:8px;font-size:9px;color:var(--txt);cursor:pointer"><input type="checkbox" checked style="accent-color:var(--gold)"> Passport copy</label>
        <label style="display:flex;gap:8px;font-size:9px;color:var(--txt);cursor:pointer"><input type="checkbox" checked style="accent-color:var(--gold)"> Company registration</label>
        <label style="display:flex;gap:8px;font-size:9px;color:var(--txt);cursor:pointer"><input type="checkbox" checked style="accent-color:var(--gold)"> Bank details / SWIFT</label>
        <label style="display:flex;gap:8px;font-size:9px;color:var(--txt);cursor:pointer" id="ulm-mandate-row"><input type="checkbox" checked style="accent-color:var(--gold)"> Mandate Letter (signed)</label>
        <label style="display:flex;gap:8px;font-size:9px;color:var(--txt);cursor:pointer"><input type="checkbox" style="accent-color:var(--gold)"> Proof of address</label>
      </div>
    </div>
    <div style="margin-bottom:12px">
    ...
    <div id="ulm-result" style="display:none;margin-top:12px;background:rgba(53,160,101,.08);border:1px solid rgba(53,160,101,.3);padding:12px">
      <div style="font-size:8px;letter-spacing:.12em;text-transform:uppercase;color:var(--green);font-weight:700;margin-bottom:6px">✓ LINK GENERATED</div>
      <div style="font-family:'JetBrains Mono',monospace;font-size:10px;color:var(--txt);background:var(--panel2);padding:8px;word-break:break-all;margin-bottom:8px" id="ulm-link-text">dealex.io/upload/DLX-secure-7f4a2b1c</div>
      <button onclick="copyLink()" style="background:var(--gold-a15);border:1px solid var(--border-mid);color:var(--gold);font-size:8.5px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;padding:8px 14px;cursor:pointer;width:100%;font-family:Montserrat,sans-serif">Copy Link</button>
    </div>
  </div>
</div>
