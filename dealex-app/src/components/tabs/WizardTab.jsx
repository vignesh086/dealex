...
<div style="font-size:13px;color:var(--muted2);margin-bottom:10px">Upload your project document and let DEALEX analyze it, or start building from scratch.</div>
...
<div style="font-size:13px;font-weight:600;color:var(--gold)">Upload Your Deal</div>
<div style="font-size:13px;color:var(--muted2);margin-top:2px">PDF, DOCX, XLSX · Multiple files OK</div>
</div>
...
<div style="font-size:20px;margin-bottom:4px">✨</div>
<div style="font-size:13px;font-weight:600;color:var(--white)">Create Your Deal</div>
<div style="font-size:13px;color:var(--muted2);margin-top:2px">Start from scratch on Deal Desk</div>
</div>
</div>
...
<div style="font-size:11px;font-weight:700;color:var(--gold);width:36px;height:44px;display:flex;flex-direction:column;align-items:center;justify-content:center;border:1px solid rgba(59,73,223,.3);flex-shrink:0" id="wizDealFileIcon">PDF</div>
<div style="flex:1;min-width:0">
<div style="font-size:13px;font-weight:600;color:var(--white);white-space:nowrap;overflow:hidden;text-overflow:ellipsis" id="wizDealFileName">—</div>
<div style="font-size:13px;color:var(--gold);margin-top:2px" id="wizDealFileStatus">Analyzing...</div>
</div>
</div>
<div id="wizDealAnalysisBody" style="font-size:13px;color:var(--txt);line-height:1.7"></div>
...
<button class="bgh" onclick="wizDealClear()" style="padding:10px 14px;font-size:11px;flex-shrink:0">CLEAR</button>
</div>
</div>
</div>
</div>
...
<div style="font-size:13px;color:var(--muted2);margin-bottom:14px">Pick the category that best describes what you're trying to build or fund.</div>
...
<div style="font-size:13px;color:var(--muted2);margin-bottom:12px">Select a project type below, or use one of our pre-built templates. Templates come with a project structure, budget breakdown, and recommended funding instrument — just customize for your country and scale.</div>

<div style="font-size:13px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:600;margin-bottom:8px">Big-ticket infrastructure</div>
...
<div style="font-size:13px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:600;margin-bottom:8px">Healthcare & social</div>
<div style="display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-bottom:12px">
...
<div style="font-size:13px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:600;margin-bottom:8px">Energy & environment</div>
<div style="display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-bottom:12px">
...
<div style="font-size:13px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:600;margin-bottom:8px">Multi-phase mega-projects</div>
...
<div style="font-size:13px;color:var(--muted);margin-top:6px;text-align:center">Don't see your project? Pick the closest match — we'll customize in the next steps.</div>
...
<div style="font-size:13px;color:var(--muted2);margin-bottom:14px">Approximate is fine. We need a rough idea of the scale.</div>
...
<div style="font-size:13px;letter-spacing:.12em;text-transform:uppercase;color:var(--green);font-weight:600;margin-bottom:4px">Template loaded</div>
<div style="font-size:13px;color:var(--txt)" id="wizTemplateDesc">Pre-filled from template. Adjust the numbers and details for your specific project.</div>
</div>
...
<div style="font-size:13px;color:var(--muted2);margin-bottom:14px">The country determines what regulatory path the funding takes — some countries have capital controls that affect how instruments are transmitted.</div>
...
<div style="font-size:13px;color:var(--muted);margin:-4px 0 8px;line-height:1.6">This affects what instruments banks will accept and whether development banks (ADB, AIIB, IFC) can co-finance. Projects with government backing typically get better terms and faster approvals.</div>
...
<div style="font-size:13px;color:var(--muted2);margin-bottom:14px">Check everything that applies. The more you have, the faster this moves.</div>
...
<div style="font-size:13px;color:var(--muted2);margin-bottom:14px">Based on what you told us, here's what DEALEX recommends.</div>
...
<div style="font-size:13px;color:var(--muted2);margin-bottom:12px">Create a free DEALEX account to save your deal, track its progress, and get matched with verified funders. Your deal stays private until you're ready.</div>
...
<div style="font-size:13px;color:var(--gold);font-weight:600;letter-spacing:.12em;text-transform:uppercase;margin-bottom:8px">Broker attachment</div>
<div style="font-size:13px;color:var(--muted2);margin-bottom:8px">As a broker, you'll be permanently attached to this deal as an introducer. If the deal closes, you'll be notified and your commission is protected under the IMFPA.</div>
...
<div style="font-size:13px;color:var(--muted);margin-top:6px;font-style:italic">By attaching to this deal, you agree to DEALEX platform terms. Your identity is verified before any commissions are assigned. You will be notified of deal status changes.</div>
</div>
...
<div style="font-size:13px;color:var(--purple,#7F77DD);font-weight:600;letter-spacing:.12em;text-transform:uppercase;margin-bottom:8px">Mandate authorization</div>
<div style="font-size:13px;color:var(--muted2);margin-bottom:8px">As a mandate, you represent the project owner. You'll need to provide authorization documentation.</div>
...
<div style="font-size:13px;color:var(--muted);margin:10px 0 12px">
...
<div style="font-size:13px;color:var(--txt);margin-bottom:8px" id="wizSavedMsg"></div>
<div style="font-size:13px;color:var(--muted)">Deal Reference: <strong style="color:var(--gold)" id="wizDealRefDisplay"></strong></div>
</div>
...
<div style="font-size:13px;color:var(--muted2);margin-bottom:14px">Create a professional funding presentation to hand to your funder team. Fill in who's representing this deal.</div>

<div style="font-size:13px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:600;margin-bottom:8px">Deal representative</div>
<div class="fr">
...
<div style="font-size:13px;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);font-weight:600;margin:14px 0 8px">Additional details for the deck</div>
...
<div style="font-size:13px;color:var(--muted);margin-top:8px;text-align:center">Creates a professional .pptx presentation with your project details, funding structure, readiness assessment, and contact information. Opens as a printable document.</div>
</div>
