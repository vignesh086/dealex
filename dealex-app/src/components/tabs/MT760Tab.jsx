...
<div id="doaSub2" style="font-size:8.5px;color:var(--muted2);margin-bottom:3px">Drag & drop your DOA here · .docx or .pdf · or click to browse</div>
...
<div class="ic" id="role-sender" onclick="selRole('sender')" style="padding:14px 8px"><div class="ii" style="font-size:24px;margin-bottom:6px">📤</div><div class="it" style="font-size:9px">Sender</div><div class="is">Issuing bank side</div></div>
<div class="ic" id="role-receiver" onclick="selRole('receiver')" style="padding:14px 8px"><div class="ii" style="font-size:24px;margin-bottom:6px">📥</div><div class="it" style="font-size:9px">Receiver</div><div class="is">Receiving bank side</div></div>
<div class="ic" id="role-mandate" onclick="selRole('mandate')" style="padding:14px 8px"><div class="ii" style="font-size:24px;margin-bottom:6px">📋</div><div class="it" style="font-size:9px">Mandate</div><div class="is">IMFPA · Commission</div></div>
<div class="ic" id="role-broker" onclick="selRole('broker')" style="padding:14px 8px"><div class="ii" style="font-size:24px;margin-bottom:6px">🤝</div><div class="it" style="font-size:9px">Broker</div><div class="is">On Mandate's IMFPA</div></div>
</div>
...
<div style="padding:0 16px;margin-bottom:14px"><div class="card"><div class="ch"><span class="chl">Print-Ready</span><span class="pill pg">Ready</span></div><div class="cb" style="text-align:center"><div style="font-size:36px;margin-bottom:8px">🏦</div><div style="font-family:'Inter', sans-serif;font-size:18px;color:var(--white);margin-bottom:4px">MT760 — SBLC</div><div id="pRef" style="font-size:9px;color:var(--muted2);margin-bottom:12px">—</div><div style="display:flex;gap:8px"><button class="bg" style="flex:2" onclick="printMT760()">🖨️ Print / Save PDF</button><button class="bgh" style="flex:1" onclick="goS(4)">← Edit</button></div></div></div></div>
<div style="padding:0 16px;display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:14px"><div class="card"><div class="cb" style="text-align:center"><div style="font-size:8px;letter-spacing:.12em;text-transform:uppercase;color:var(--muted);margin-bottom:4px">Issuer (:52A:)</div><div id="rvIB" style="font-size:11px;font-weight:600;color:var(--white)">—</div><div id="rvIS" style="font-family:'JetBrains Mono',monospace;font-size:8px;color:var(--gold);margin-top:4px">—</div></div></div><div class="card"><div class="cb" style="text-align:center"><div style="font-size:8px;letter-spacing:.12em;text-transform:uppercase;color:var(--muted);margin-bottom:4px">Advising (:56A:)</div><div id="rvRB" style="font-size:11px;font-weight:600;color:var(--white)">—</div><div id="rvRS" style="font-family:'JetBrains Mono',monospace;font-size:8px;color:var(--gold);margin-top:4px">—</div></div></div></div>
