...
<div style="font-size:13px;letter-spacing:.2em;text-transform:uppercase;color:var(--gold);font-weight:700;margin-bottom:8px">DEALEX PLATFORM</div>
...
<div style="font-size:13px;color:var(--txt);line-height:1.7;margin-bottom:10px">DEALEX controls deal sequence. We verify documents, protect all parties, and execute SWIFT transmissions — in the right order, every time.</div>
<div style="display:flex;gap:8px;flex-wrap:wrap">
<div style="padding:4px 10px;background:rgba(53,160,101,.15);border:1px solid rgba(53,160,101,.3);font-size:13px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:var(--green)">✓ ISP98</div>
<div style="padding:4px 10px;background:rgba(53,160,101,.15);border:1px solid rgba(53,160,101,.3);font-size:13px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:var(--green)">✓ UCP600</div>
<div style="padding:4px 10px;background:rgba(53,160,101,.15);border:1px solid rgba(53,160,101,.3);font-size:13px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:var(--green)">✓ FATF/AML</div>
<div style="padding:4px 10px;background:rgba(53,160,101,.15);border:1px solid rgba(53,160,101,.3);font-size:13px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:var(--green)">✓ URDG758</div>
</div>
</div>
</div>
...
<div style="font-size:13px;letter-spacing:.18em;text-transform:uppercase;color:var(--gold);font-weight:700;margin-bottom:12px">▸ WHAT TYPE OF DEAL DO YOU HAVE?</div>
...
<div style="font-size:13px;font-weight:700;color:#4A8BE0;margin-bottom:2px">PROJECT FUNDING</div>
<div style="font-size:13px;color:var(--muted2)">SBLC · MT760 · 366 days</div>
<div style="font-size:11px;color:var(--muted);margin-top:4px">Soft costs → bankable project</div>
</div>
...
<div style="font-size:13px;font-weight:700;color:var(--green);margin-bottom:2px">COMMODITY TRADE</div>
<div style="font-size:13px;color:var(--muted2)">DLC · MT700 · B/L · COO</div>
<div style="font-size:11px;color:var(--muted);margin-top:4px">Bauxite · Crude · Gold · Agri</div>
</div>
</div>
</div>
...
<div style="padding:0 16px;margin-bottom:20px">
<div style="font-size:13px;letter-spacing:.18em;text-transform:uppercase;color:var(--gold);font-weight:700;margin-bottom:12px">▸ HOW EVERY DEAL MOVES</div>
...
<div style="font-size:11px;font-weight:700;color:var(--gold);text-align:center;letter-spacing:.05em">NCNDA</div>
<div style="font-size:11px;color:var(--muted);text-align:center">Both sign</div>
</div>
<!-- Connector -->
...
<div style="font-size:11px;font-weight:700;color:#4A8BE0;text-align:center;letter-spacing:.05em">KYC/CIS</div>
<div style="font-size:11px;color:var(--muted);text-align:center">Simultaneous</div>
</div>
...
<div style="font-size:11px;font-weight:700;color:var(--gold);text-align:center;letter-spacing:.05em">DOA</div>
<div style="font-size:11px;color:var(--muted);text-align:center">Auth docs</div>
</div>
...
<div style="display:flex;flex-direction:column;align-items:center;min-width:56px;gap:4px">
<div style="width:36px;height:36px;border-radius:50%;background:rgba(59,73,223,.15);border:2px solid rgba(59,73,223,.4);display:flex;align-items:center;justify-content:center;font-size:14px">📃</div>
<div style="font-size:11px;font-weight:700;color:var(--gold);text-align:center;letter-spacing:.05em">IMFPA</div>
<div style="font-size:11px;color:var(--muted);text-align:center">Fee protect</div>
</div>
<div style="flex:1;min-width:12px;height:2px;background:linear-gradient(90deg,rgba(59,73,223,.4),rgba(59,73,223,.4));margin-bottom:18px"></div>
<!-- Step 5 -->
<div style="display:flex;flex-direction:column;align-items:center;min-width:56px;gap:4px">
<div style="width:36px;height:36px;border-radius:50%;background:rgba(59,73,223,.15);border:2px solid rgba(59,73,223,.4);display:flex;align-items:center;justify-content:center;font-size:14px">🏦</div>
<div style="font-size:11px;font-weight:700;color:var(--gold);text-align:center;letter-spacing:.05em">SWIFT</div>
<div style="font-size:11px;color:var(--muted);text-align:center">Bank pkg</div>
</div>
...
<div style="font-size:11px;font-weight:700;color:var(--green);text-align:center;letter-spacing:.05em">CLOSED</div>
<div style="font-size:11px;color:var(--muted);text-align:center">Funds out</div>
</div>
</div>
<div style="margin-top:10px;padding:8px;background:rgba(255,255,255,.02);border-top:1px solid var(--border)">
<div style="font-size:13px;color:var(--muted2);text-align:center">DEALEX controls sequencing — no step is skipped, no party is exposed before the prior step is verified.</div>
</div>
</div>
</div>
...
<div style="padding:0 16px;margin-bottom:20px">
<div style="font-size:13px;letter-spacing:.18em;text-transform:uppercase;color:var(--gold);font-weight:700;margin-bottom:12px">▸ PAYMENT PATH — MOST TO LEAST DESIRABLE</div>
<div style="background:var(--panel);border:1px solid var(--border);padding:14px">
<div style="display:flex;flex-direction:column;gap:6px">
<!-- TT Wire -->
<div style="display:flex;align-items:center;gap:10px">
<div style="width:20px;height:20px;border-radius:50%;background:var(--green);display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700;color:#000;flex-shrink:0">1</div>
<div style="flex:1">
...
<span style="font-size:13px;font-weight:700;color:var(--green);z-index:1">TT Wire (MT103)</span>
<span style="font-size:11px;color:var(--muted2);margin-left:8px;z-index:1">Fastest · Direct bank-to-bank · Best for seller</span>
</div>
</div>
</div>
<!-- DLC at Sight -->
<div style="display:flex;align-items:center;gap:10px">
<div style="width:20px;height:20px;border-radius:50%;background:rgba(59,73,223,.9);display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700;color:#000;flex-shrink:0">2</div>
<div style="flex:1">
...
<span style="font-size:13px;font-weight:700;color:var(--gold)">DLC at Sight (MT700)</span>
<span style="font-size:11px;color:var(--muted2);margin-left:8px">Bank-guaranteed · Gold standard for trade</span>
</div>
</div>
</div>
<!-- DLC Deferred -->
<div style="display:flex;align-items:center;gap:10px">
<div style="width:20px;height:20px;border-radius:50%;background:rgba(59,73,223,.6);display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700;color:#000;flex-shrink:0">3</div>
<div style="flex:1">
...
<span style="font-size:13px;font-weight:600;color:var(--txt)">DLC Deferred (30/60/90d)</span>
<span style="font-size:11px;color:var(--muted2);margin-left:8px">Guaranteed · Buyer gets delivery time</span>
</div>
</div>
</div>
<!-- SBLC backed -->
<div style="display:flex;align-items:center;gap:10px">
<div style="width:20px;height:20px;border-radius:50%;background:rgba(59,73,223,.4);display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700;color:#000;flex-shrink:0">4</div>
<div style="flex:1">
...
<span style="font-size:13px;color:var(--muted2)">SBLC-backed Wire</span>
<span style="font-size:11px;color:var(--muted);margin-left:8px">Draw on SBLC if buyer defaults</span>
</div>
</div>
</div>
<!-- Collection -->
<div style="display:flex;align-items:center;gap:10px">
<div style="width:20px;height:20px;border-radius:50%;background:rgba(208,64,64,.5);display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700;color:#fff;flex-shrink:0">5</div>
<div style="flex:1">
...
<span style="font-size:13px;color:var(--red)">Documentary Collection</span>
<span style="font-size:11px;color:var(--muted);margin-left:8px">No bank guarantee · Higher risk</span>
</div>
</div>
</div>
</div>
...
<div style="flex:1">
<div style="font-size:13px;font-weight:700;color:var(--white);margin-bottom:4px">KYC / CIS — Protected on DEALEX</div>
<div style="font-size:13px;color:var(--muted2);line-height:1.7;margin-bottom:6px">Your CIS goes to the <strong style="color:var(--white)">platform only</strong> — never to the other party. Counterparty sees only:</div>
...
<span style="font-size:13px;font-weight:700;color:var(--green)">KYC VERIFIED</span>
</div>
</div>
</div>
</div>
...
<!-- Quick nav cards -->
<div style="padding:0 16px;margin-bottom:20px">
<div style="font-size:13px;letter-spacing:.18em;text-transform:uppercase;color:var(--gold);font-weight:700;margin-bottom:12px">▸ NAVIGATE</div>
<div class="ig">
...
<!-- Live Deals -->
<div style="padding:0 16px;margin-bottom:20px"><div class="card"><div class="ch"><span class="chl">Live Deals</span><span class="pill po">3 Active</span></div><div class="cb"><div style="display:flex;justify-content:space-between;border-bottom:1px solid var(--border);padding:6px 0;font-size:13px"><span style="color:var(--white);font-weight:500">SBLC — EUR 100M</span><span class="pill pg">In Progress</span></div><div style="display:flex;justify-content:space-between;border-bottom:1px solid var(--border);padding:6px 0;font-size:13px"><span style="color:var(--white);font-weight:500">Bauxite 49,739 MT — Kuantan</span><span class="pill po">Pending KYC</span></div><div style="display:flex;justify-content:space-between;padding:6px 0;font-size:13px"><span style="color:var(--white);font-weight:500">MT103 Wire — USD 5M</span><span class="pill pr">Review</span></div></div></div></div>
...
<div style="font-size:13px;color:var(--txt);line-height:1.7;margin-bottom:14px">The DEALEX Wizard walks you through it. No jargon. Tell us about your project and we'll show you exactly what you need.</div>
<div style="display:block;padding:10px 22px;background:var(--gold);color:var(--obs);font-size:13px;font-weight:700;letter-spacing:.15em;text-transform:uppercase;font-family:Montserrat,sans-serif;width:fit-content">Start the Wizard →</div>
</div>
</div>
` }} />
  )
