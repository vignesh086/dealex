...
<div style="padding:0 16px"><div class="card"><div class="cb" style="text-align:center;padding:30px"><div style="font-size:36px;margin-bottom:10px">👨‍💼</div><div style="font-size:11px;color:var(--white);font-weight:600">Expert Network</div><div style="font-size:9px;color:var(--muted2);margin-top:4px">DEALEX Desk · Lv.25 Banker · Law · Gold</div></div></div></div>
